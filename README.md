...
> confinement cannot grant, and the store reasonably wants more development
> history from a young project; it will be revisited once the project has a
> longer track record. The PPA and `.deb` are fully supported and are the
